...
export type Props = {
  ...
  type: 'navigation' | 'profiler' | 'settings' | 'naviTab',
};
...
export default function TabBar({
  ...
  switch (type) {
    ...
    case 'settings':
      ...
      break;
    case 'naviTab':
      iconSizeClassName = styles.IconSizeNaviTab;
      tabLabelClassName = styles.TabLabelNaviTab;
      tabSizeClassName = styles.TabSizeNaviTab;
      break;
    default:
