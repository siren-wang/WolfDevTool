...
import {useHighlightNativeElement, useLocalStorage, useSubscription} from '../hooks';
...
import CommitFlamegraph from '../Profiler/CommitFlamegraph';
      ...
      <div className={styles.Tree} ref={treeRef}>
        <div className={styles.SearchInput}>
          ...
          <Suspense fallback={<Loading />}>
            {ownerID !== null ? <OwnersStack /> : (selectedTabID === 'tree' ? <ComponentSearchInput /> : <RequestSearchInput />)}
          </Suspense>
