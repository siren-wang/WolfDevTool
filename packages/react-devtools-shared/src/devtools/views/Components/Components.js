...
const LOCAL_STORAGE_KEY = 'Wolf::DevTools::createResizeReducer';
const VERTICAL_MODE_MAX_WIDTH = 600;
const MINIMUM_SIZE = 50;

export function initResizeState(localStorageKey = LOCAL_STORAGE_KEY): ResizeState {
...
export function resizeReducer(state: ResizeState, action: ResizeAction): ResizeState {
  switch (action.type) {
...
export function setResizeCSSVariable(
