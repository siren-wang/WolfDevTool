...
export default function InspectedElementDataTree({
  bridge,
  element,
  inspectedElement,
  store,
  ...
  const entries = props?.data != null ? Object.entries(props.data) : null;
  if (entries !== null) {
  ...
  const handleCopy = () => copy(serializeDataForCopy(((props?.data: any): Object)));
