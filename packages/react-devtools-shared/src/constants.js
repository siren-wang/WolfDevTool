...
export const LOCAL_STORAGE_NETWORK_FILTER_WOLF_RPOXY = 'Wolf::DevTools::networkFilterWolfProxy';

export const LOCAL_STORAGE_NETWORK_GENERAL = 'Wolf::DevTools::networkGeneral';

export const LOCAL_STORAGE_NETWORK_RESPONSE_HEADERS = 'Wolf::DevTools::networkResponseHeaders';

export const LOCAL_STORAGE_NETWORK_REQUEST_HEADERS = 'Wolf::DevTools::networkRequestHeaders';
